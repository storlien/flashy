...
const frameworks = [
  { value: 'Titsmangel', label: 'Titsmangel' },
  { value: 'Titsønske', label: 'Titsønske' },
  { value: 'Titsforhold', label: 'Titsforhold' },
  { value: 'Titsbruk', label: 'Titsbruk' },
  { value: 'Titspunkt', label: 'Titspunkt' },
  { value: 'Hanna er irriterende', label: 'Hanna er irriterende'},
  { value: 'Titspress', label: 'Titspress'},
]
