    ...
    <div id="new-set-page">
        ...
        <div id="center-column">
            ...
            <div v-for="row, index in rows" class="row" :key="row.id">
                ...
                <div>
                    <h3>Spørsmål</h3>
                    <OneSideFlash :vModel="row.question"></OneSideFlash>
                </div>
                <div>
                    <h3>Svar</h3>
                    <OneSideFlash :vModel="row.answer"></OneSideFlash>
                </div>
                <Button @click="removeRow(index)" variant="outline">X</Button>
            </div>
            <div class="button-container">
                <Button type="submit" @click="addRow">Legg til nytt flashkort</Button>
            </div>
...
import OneSideFlash  from '@/components/flashy/OneSideFlash.vue';
